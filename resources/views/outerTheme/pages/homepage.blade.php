    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('/assets/outerTheme/images/banner-02.jpg')}}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('/assets/outerTheme/images/banner-03.jpg')}}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('/assets/outerTheme/images/banner-01.jpg')}}" class="d-block w-100" alt="...">
            </div>
        </div>
        ...
        <div class="services small_pb">
            <div class="container-lg">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                       <div class="abt-img"><img src="{{ asset('/assets/outerTheme/images/rhe-flat.jpg')}}"></div>
                    </div>
                </div>
            </div>
        </div>
